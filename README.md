...
### Текущие ошибки
- При попытке обновления файла баннера через админку выкидывает на страницу "доступ запрещен", хз пока почему
- Не отображает превьюхи баннеров на странице
- Не отдает запросы без авторизации
